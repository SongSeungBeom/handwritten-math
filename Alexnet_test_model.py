...
testloader1 = DataLoader(testset1, batch_size=32, shuffle= False)
testloader2 = DataLoader(testset2, batch_size=32, shuffle= False)
testloader3 = DataLoader(testset3, batch_size=32, shuffle= False)
...
if __name__ == '__main__':
    net = AlexNet()
    net.load_state_dict(torch.load('./model/Alexnet_3.pt'))
